    ...
    <br>
        <table border="1" >
          <thead>
            ...
            $sql="SELECT u.foto as foto_u, destinario, mensaje, fecha_envio, m.foto as foto_m, usuario FROM  mensajes m inner join usuarios u on destinario = usuario WHERE autor='$user'";
            ...
            <tr>
                    ...
                    <td><?php echo $mostrar['destinario'] ?></td>
